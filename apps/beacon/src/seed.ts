// Local dev seed — used only when no Supabase creds are set.
// Two distinct accounts prove the engine: different slug => different content.
import type { BeaconRow } from "./types.ts";

export const SEED: Record<string, BeaconRow> = {
  // ---- Account 1 : HR analytics (multiply_compare resource) -----------------
  "nw-7f3a9c21e8": {
    company_name: "Northwind",
    round_type: "Series A",
    hire_title: "VP of Sales",
    icp_industry: "HR Tech · Workforce Analytics",
    icp_size: "200–1,000 employees",
    icp_buyer_titles: ["CHRO", "VP People", "Head of People Ops"],
    use_case: "turning scattered workforce data into retention decisions",
  ...
  // ---- Account 2 : payments infra (divide_into_units resource) --------------
  "cd-2b8f4d9011": {
    company_name: "Cadence",
    round_type: "Series B",
    hire_title: "CRO",
    icp_industry: "Fintech · Payments Infrastructure",
    icp_size: "500–2,000 employees",
    icp_buyer_titles: ["VP Payments", "Head of Finance Ops", "Director of Treasury"],
    use_case: "cutting failed-payment leakage for subscription businesses",
    generated_date: "18 June 2026",
    report_content: {
      ...
      mock_beacon: {
        archetype: "scorecard",
        title: "Revenue Leakage Scorecard",
      ...
      resource_params: {
        archetype: "calculator",
        title: "Failed-Payment Recovery Estimator",
...
export const DEFAULT_SLUG = "nw-7f3a9c21e8";
